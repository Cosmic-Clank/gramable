...
export default function TOS() {
	return (
		<main className={`flex flex-col items-center justify-center bg-zinc-100 overflow-hidden ${font.className}`}>
			<section className='w-full px-8 py-16 bg-white relative'>
				<h1>Terms of Service</h1>
				<div>
					<strong>OVERVIEW</strong> <br />
					This website is operated by GRAMABLE. Throughout the site, the terms “we”, “us” and “our” refer to GRAMABLE. GRAMABLE offers this website, including all information, tools, and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies, and notices stated here. <br />
					<br />
