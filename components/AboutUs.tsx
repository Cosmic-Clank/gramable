...
"
						/>
						<TextWordStagger containerClassName='max-w-xl' className='text-xl text-gray-700' text="Partner with us and let's transform your social media presence into a powerful platform for growth and connection." />
					</div>
				</div>
